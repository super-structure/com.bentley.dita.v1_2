...
PUBLIC "-//BENTLEY//ELEMENTS DITA Programming Domain//EN"
      Delivered as file "bentley_programmingDomain.mod"            -->
...
<!--    2013.01.04 JTC: Bentley copy created and Bentley-speicific -->
<!--                      elements added                           -->
<!--    2013.03.08 JTC: Fixed issue with kwdchoice attlist         -->
<!-- ============================================================= -->
...
<!-- 2013-01-04 JTC: MicroStatoin keyword-specific elements added  -->
<!ENTITY % keyin		"keyin"										 >
<!ENTITY % kwdchoice	"kwdchoice"									 >
...
<!-- 2013-01-04 JTC: MicroStatoin keyword-specific elements added  -->
<!--                    LONG NAME: MicroStation Key-in              -->
<!ENTITY % keyin.content		
                        "((%kwd; | 
                        %kwdchoice;),
						(%kwd; | 
						%kwdchoice; | 
...
<!ELEMENT keyin     %keyin.content;>
<!ATTLIST keyin     %keyin.attributes; >

<!--                    LONG NAME: MicroStation Group Choice       -->
<!ENTITY % kwdchoice.content	
                        "(%kwd;)+"
>
<!ENTITY % kwdchoice.attributes    
             "importance 
                        (default |
                         required | 
                         optional | 
              ...
              outputclass 
                        CDATA
                                  #IMPLIED" > 
<!ELEMENT kwdchoice %kwdchoice.content; >
<!ATTLIST kwdchoice %kwdchoice.attributes; >
...
<!-- 2013-01-04 JTC: MicroStatoin keyword-specific elements added  -->
<!ATTLIST  keyin       %global-atts; class CDATA "+ topic/figgroup pr-d/keyin "  	>
<!ATTLIST  kwdchoice 
                      %global-atts; class CDATA "+ topic/figgroup pr-d/kwdchoice " >
